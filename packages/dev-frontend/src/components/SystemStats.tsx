...
export const SystemStats: React.FC<SystemStatsProps> = ({ variant = "info", showBalances }) => {
  ...
  return (
    <Card {...{ variant }}>
      ...
      <Heading>DCHF statistics</Heading>
      ...
      <Statistic
        name="Borrowing Fee"
        tooltip="The Borrowing Fee is a one-off fee charged as a percentage of the borrowed amount (in DCHF) and is part of a Trove's debt. The fee varies between 0.5% and 5% depending on DCHF redemption volumes."
      >
      ...
      <Statistic name="DCHF supply" tooltip="The total DCHF minted by the Liquity Protocol.">
        {total.debt.shorten()}
      </Statistic>
      {lusdInStabilityPoolPct && (
        <Statistic
          name="DCHF in Stability Pool"
          tooltip="The total DCHF currently held in the Stability Pool, expressed as an amount and a fraction of the DCHF supply.
        "
        >
