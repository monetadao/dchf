...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale })

      // Whale transfers 10k DCHF to A, B and C who then deposit it to the SP
      const depositors = [alice, bob, carol]
      for (account of depositors) {
        await DCHFToken.transfer(account, dec(20000, 18), { from: whale })
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      // Check depositors' compounded deposit is 6666.66 DCHF and ETH Gain is 33.16 ETH
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('6666666666666666666666').mul(toBN(2))), 20000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('6666666666666666666666').mul(toBN(2))), 20000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('6666666666666666666666').mul(toBN(2))), 20000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })

      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      // Check depositors' compounded deposit is 3333.33 DCHF and ETH Gain is 66.33 ETH
      const txA = await stabilityPool.withdrawFromSP(dec(10000, 18), { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(10000, 18), { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(10000, 18), { from: carol })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('3333333333333333333333').mul(toBN(2))), 20000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('3333333333333333333333').mul(toBN(2))), 20000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('3333333333333333333333').mul(toBN(2))), 20000)
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(100, 'ether') })

      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      ...
      // Check depositors' compounded deposit is 0 DCHF and ETH Gain is 99.5 ETH 
      const txA = await stabilityPool.withdrawFromSP(dec(10000, 18), { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(10000, 18), { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(10000, 18), { from: carol })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), '0'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing DCHF", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale })
      ...
      await borrowerOperations.openTrove(erc20.address, '50000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, '70000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(7000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('6000000000000000000000').mul(toBN(2))), 20000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('6000000000000000000000').mul(toBN(2))), 20000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('6000000000000000000000').mul(toBN(2))), 20000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing DCHF", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale })
      ...
      await borrowerOperations.openTrove(erc20.address, '50000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, '60000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(6000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, '70000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(7000, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('4000000000000000000000').mul(toBN(2))), 10000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('4000000000000000000000').mul(toBN(2))), 10000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('4000000000000000000000').mul(toBN(2))), 10000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await DCHFToken.transfer(bob, dec(20000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(20000, 18), { from: bob })
      await DCHFToken.transfer(carol, dec(30000, 18), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('6666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('13333333333333333333333').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('20000000000000000000000').mul(toBN(2))), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('5000000000000000000000').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('10000000000000000000000').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('15000000000000000000000').mul(toBN(2))), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(1000000, 18)), whale, whale, { from: whale, value: dec(1000000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(1000000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(1000000, 18)), whale, whale, { from: whale })

      /* Depositors provide:-
      Alice:  2000 DCHF
      Bob:  456000 DCHF
      Carol: 13100 DCHF */
      // Whale transfers DCHF to  A, B and C respectively who then deposit it to the SP
      await DCHFToken.transfer(alice, dec(2000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(2000, 18), { from: alice })
      await DCHFToken.transfer(bob, dec(456000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(456000, 18), { from: bob })
      await DCHFToken.transfer(carol, dec(13100, 18), { from: whale })
      ...
      Defaulter 1: 207000 DCHF & 2160 ETH
      ...
      */
      ...
      await borrowerOperations.openTrove(erc20.address, dec(2160, 18), th._100pct, await getOpenTroveDCHFAmount('207000000000000000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, dec(50, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(5, 21)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, dec(500, 'ether'), th._100pct, await getOpenTroveDCHFAmount('46700000000000000000000'), defaulter_3, defaulter_3, { from: defaulter_3 })
      ...
      // ()
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('901719380174061000000').mul(toBN(2))), 100000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('205592018679686000000000').mul(toBN(2))), 10000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('5906261940140100000000').mul(toBN(2))), 10000000000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 DCHF.  A, B, C, D withdraw correct DCHF deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale })
      ...
      await DCHFToken.transfer(dennis, dec(20000, 18), { from: whale })
      ...
      console.log()
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('1666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('1666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('1666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN('5000000000000000000000').mul(toBN(2))), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 DCHF.  A, B, C, D withdraw correct DCHF deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale })
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_4, defaulter_4, { from: defaulter_4, value: dec(100, 'ether') })

      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct DCHF deposit and ETH Gain", async () => {
      // Whale opens Trove with 1m ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(1000000, 18)), whale, whale, { from: whale, value: dec(1000000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(1000000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(1000000, 18)), whale, whale, { from: whale })
      ...
      */
      // Whale transfers DCHF to  A, B and C respectively who then deposit it to the SP
      await DCHFToken.transfer(alice, dec(60000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(60000, 18), { from: alice })
      await DCHFToken.transfer(bob, dec(20000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(20000, 18), { from: bob })
      await DCHFToken.transfer(carol, dec(15000, 18), { from: whale })
      ...
      /* Defaulters open troves:
      Defaulter 1:  10000 DCHF, 100 ETH
      Defaulter 2:  25000 DCHF, 250 ETH
      Defaulter 3:  5000 DCHF, 50 ETH
      Defaulter 4:  40000 DCHF, 400 ETH
      */
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(25000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: '250000000000000000000' })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_3, defaulter_3, { from: defaulter_3, value: '50000000000000000000' })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(40000, 18)), defaulter_4, defaulter_4, { from: defaulter_4, value: dec(400, 'ether') })

      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, })
      await borrowerOperations.openTrove(erc20.address, '250000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(25000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, })
      await borrowerOperations.openTrove(erc20.address, '50000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_3, defaulter_3, { from: defaulter_3, })
      await borrowerOperations.openTrove(erc20.address, dec(400, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(40000, 18)), defaulter_4, defaulter_4, { from: defaulter_4, })
      ...
      // Dennis provides 25000 DCHF
      await DCHFToken.transfer(dennis, dec(25000, 18), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('17832817337461300000000').mul(toBN(2))), 100000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('5944272445820430000000').mul(toBN(2))), 100000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('4458204334365320000000').mul(toBN(2))), 100000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN('11764705882352900000000').mul(toBN(2))), 100000000000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 DCHF.  A, B, C, D withdraw correct DCHF deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), '0'), 1000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct DCHF deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      ...
      Dennis: 40000 DCHF
      */
      // Whale transfers DCHF to  A, B,C and D respectively who then deposit it to the SP
      await DCHFToken.transfer(alice, dec(20000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(20000, 18), { from: alice })
      await DCHFToken.transfer(bob, dec(25000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(25000, 18), { from: bob })
      await DCHFToken.transfer(carol, dec(12500, 18), { from: whale })
      await stabilityPool.provideToSP(dec(12500, 18), { from: carol })
      await DCHFToken.transfer(dennis, dec(40000, 18), { from: whale })
      ...
      /* Defaulters open troves:
      Defaulter 1: 10000 DCHF
      Defaulter 2: 20000 DCHF
      ...
      */
      ...
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, dec(200, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, dec(300, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(30000, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.openTrove(erc20.address, '50000000000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, EVENT_ASSET_GAIN_NAME, EVENT_ASSET_GAIN_PARAM).toString()
      const dennis_ETHWithdrawnERC20 = th.getEventArgByName(txDERC20, EVENT_ASSET_GAIN_NAME, EVENT_ASSET_GAIN_PARAM).toString()
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN('27692307692307700000000').mul(toBN(2))), 100000000000)
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('1672240802675590000000').mul(toBN(2))), 10000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('2090301003344480000000').mul(toBN(2))), 100000000000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('1045150501672240000000').mul(toBN(2))), 100000000000)
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 DCHF. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct DCHF deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18), erc20.address), whale, whale, { from: whale })
      ...
      // Carol makes deposit
      await DCHFToken.transfer(carol, dec(10000, 18), { from: whale })
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, EVENT_ASSET_GAIN_NAME, EVENT_ASSET_GAIN_PARAM).toString()
      const dennis_ETHWithdrawnERC20 = th.getEventArgByName(txDERC20, EVENT_ASSET_GAIN_NAME, EVENT_ASSET_GAIN_PARAM).toString()
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN('1666666666666666666666').mul(toBN(2))), 100000)
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), toBN('666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('2000000000000000000000').mul(toBN(2))), 100000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // 2 Defaulters open trove with 200% ICR
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(200, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })

      await borrowerOperations.openTrove(erc20.address, dec(200, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(10000, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })

      // price drops by 50%: defaulter ICR falls to 100%
      await priceFeed.setPrice(dec(100, 18));

      // Defaulter 1 liquidated. 20000 DCHF fully offset with pool.
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_1, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_1, { from: owner });

      // Carol, Dennis each deposit 10000 DCHF
      ...
      // Defaulter 2 liquidated. 10000 DCHF offset
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_2, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_2, { from: owner });
      ...
      // Expect Alice And Bob's compounded deposit to be 0 DCHF
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), '0'), 10000)
      ...
      // Expect Carol And Dennis' compounded deposit to be 50 DCHF
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('5000000000000000000000').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN('5000000000000000000000').mul(toBN(2))), 100000)
    ...
    it("withdrawFromSP(): Pool-emptying liquidation increases epoch by one, resets scaleFactor to 0, and resets P to 1e18", async () => {
      ...
      // Defaulter 1 liquidated. 10--0 DCHF fully offset, Pool remains non-zero
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_1, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_1, { from: owner });
      ...
      // Defaulter 2 liquidated. 1--00 DCHF, empties pool
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_2, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_2, { from: owner });
      ...
      // Defaulter 3 liquidated. 10000 DCHF fully offset, Pool remains non-zero
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_3, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_3, { from: owner });
      ...
      // Defaulter 4 liquidated. 10000 DCHF, empties pool
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_4, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_4, { from: owner });
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // Carol, Dennis, Erin each deposit 10000, 20000, 30000 DCHF respectively
      await DCHFToken.transfer(carol, dec(10000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(10000, 18), { from: carol })
      await DCHFToken.transfer(dennis, dec(20000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(20000, 18), { from: dennis })
      await DCHFToken.transfer(erin, dec(30000, 18), { from: whale })
      ...
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN('8333333333333333333333').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN('16666666666666666666666').mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(erin)).toString(), toBN('25000000000000000000000').mul(toBN(2))), 100000)
    ...
    // A deposits 10000
    // L1, L2, L3 liquidated with 10000 DCHF each
    // A withdraws all
    ...
    // A,B deposit 10000 DCHF
    // L1 cancels 20000 DCHF, 2E
    // B,C deposits 10000 DCHF
    // L2 cancels 20000 DCHF, 2E
    // E,F deposit 10000 DCHF
    // L3 cancels 20000, 200E
    // G,H deposits 10000
    // L4 cancels 20000, 200E

    // Expect all depositors withdraw 0 DCHF and 100 ETH
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(200, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(200, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(200, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(20000, 18)), defaulter_4, defaulter_4, { from: defaulter_4, value: dec(200, 'ether') })
      ...
      // Alice, Bob each deposit 10k DCHF
      ...
      // Erin, Flyn each deposit 10000 DCHF
      ...
      // Defaulter 3 liquidated. 10000 DCHF offset
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_3, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_3, { from: owner });

      // Graham, Harriet each deposit 10000 DCHF
      ...
      // Defaulter 4 liquidated. 10k DCHF offset
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_4, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_4, { from: owner });
      ...
      // Expect all deposits to be 0 DCHF
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(alice)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(erin)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(flyn)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(graham)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(harriet)).toString(), '0'), 100000)
    ...
    // A withdraws all
    // B deposits 10000
    // L2 of 9900 DCHF, should bring P slightly past boundary i.e. 1e-9 -> 1e-10
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999999910000000000000'), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      ...
      // Defaulter 2 liquidated.  9900 DCHF liquidated. P altered by a factor of 1-(9900/10000) = 0.01.  Scale changed.
      await troveManager.liquidate(ZERO_ADDRESS, defaulter_2, { from: owner });
      await troveManager.liquidate(erc20.address, defaulter_2, { from: owner });
      ...
      // Expect Bob to withdraw 1% of initial deposit (100 DCHF) and all the liquidated ETH (60 ether)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN('100000000000000000000').mul(toBN(2))), 100000)
    ...
    // A deposits 10000
    // L1 brings P close to boundary, i.e. 9e-9: liquidate 9999.99991 DCHF
    // A withdraws all
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('59400000000000000000000'), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(330, 'ether') })
      ...
      await stabilityPool.provideToSP(dec(10000, 18), { from: bob })
      await DCHFToken.transfer(carol, dec(20000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(20000, 18), { from: carol })
      await DCHFToken.transfer(dennis, dec(30000, 18), { from: whale })
      ...
      // 54000 DCHF liquidated.  P altered by a factor of 1-(59400/60000) = 0.01. Scale changed.
      ...
      Bob:  1000 DCHF, 55 Ether
      Carol:  2000 DCHF, 110 Ether
      Dennis:  3000 DCHF, 165 Ether
     
      Total: 6000 DCHF, 300 Ether
      */
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN(dec(100, 18)).mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN(dec(200, 18)).mul(toBN(2))), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN(dec(300, 18)).mul(toBN(2))), 100000)
    ...
    // A make deposit 10000 DCHF
    // L1 brings P to 1e-5*P. L1:  9999.9000000000000000 DCHF
    // A withdraws
    // B makes deposit 10000 DCHF
    // L2 decreases P again by 1e-5, over the scale boundary: 9999.9000000000000000 (near to the 10000 DCHF total deposits)
    // B withdraws
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })
      ...
      // Bob should withdraw 1e-5 of initial deposit: 0.1 DCHF and the full ETH gain of 100 ether
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN(dec(1, 17)).mul(toBN(2))), 100000)
    ...
    // L2 decreases P again by 1e-5, over boundary. L2: 59999.4000000000000000  (near to the 60000 DCHF total deposits)
    // B withdraws
    // expect d(B) = d0(B) * 1e-5
    // expect B gets entire ETH gain from L2
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999900000000000000000'), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('59999400000000000000000'), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(600, 'ether') })

      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount('9999900000000000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      // B, C, D deposit 10000, 20000, 30000 DCHF
      await DCHFToken.transfer(bob, dec(10000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(10000, 18), { from: bob })
      await DCHFToken.transfer(carol, dec(20000, 18), { from: whale })
      await stabilityPool.provideToSP(dec(20000, 18), { from: carol })
      ...
      // {B, C, D} should have a compounded deposit of {0.1, 0.2, 0.3} DCHF
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(bob)).toString(), dec(1, 17)), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(carol)).toString(), dec(2, 17)), 100000)
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), dec(3, 17)), 100000)
    ...
    // A make deposit 10000 DCHF
    // L1 brings P to (~1e-10)*P. L1: 9999.9999999000000000 DCHF
    ...
    it("withdrawFromSP(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999999999900000000000'), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      ...
      const aliceDeposit = (await stabilityPool.getCompoundedDCHFDeposit(alice)).toString()
      const aliceDepositERC20 = (await stabilityPoolERC20.getCompoundedDCHFDeposit(alice)).toString()
    ...
    /* A make deposit 10000 DCHF
    L1 brings P to 0.0001P. L1:  9999.900000000000000000 DCHF, 1 ETH
    B makes deposit 9999.9, brings SP to 10k
    L2 decreases P by(~1e-5)P. L2:  9999.900000000000000000 DCHF, 1 ETH
    C makes deposit 9999.9, brings SP to 10k
    L3 decreases P by(~1e-5)P. L3:  9999.900000000000000000 DCHF, 1 ETH
    D makes deposit 9999.9, brings SP to 10k
    L4 decreases P by(~1e-5)P. L4:  9999.900000000000000000 DCHF, 1 ETH
    expect A, B, C, D each withdraw ~100 Ether
    */
    it("withdrawFromSP(): Several deposits of 10000 DCHF span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18)), whale, whale, { from: whale, value: dec(100000, 'ether') })
      await borrowerOperations.openTrove(erc20.address, dec(100000, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(100000, 18), erc20.address), whale, whale, { from: whale })
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999900000000000000000'), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999900000000000000000'), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999900000000000000000'), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount('9999900000000000000000'), defaulter_4, defaulter_4, { from: defaulter_4, value: dec(100, 'ether') })
      ...
      // B deposits 9999.9 DCHF
      await DCHFToken.transfer(bob, dec(99999, 17), { from: whale })
      ...
      // C deposits 9999.9 DCHF
      await DCHFToken.transfer(carol, dec(99999, 17), { from: whale })
      ...
      // D deposits 9999.9 DCHF
      await DCHFToken.transfer(dennis, toBN(dec(99999, 17)).mul(toBN(2)), { from: whale })
      ...
      assert.equal(await DCHFToken.balanceOf(alice), '0')
      assert.equal(await DCHFToken.balanceOf(alice), '0')
      assert.equal(await DCHFToken.balanceOf(alice), '0')
      // D should withdraw around 0.9999 DCHF, since his deposit of 9999.9 was reduced by a factor of 1e-5
      assert.isAtMost(th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN(dec(99999, 12)).mul(toBN(2))), 100000)
    ...
    it("withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(24100, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(200, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(24300, 18)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(200, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(24500, 18)), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(200, 'ether') })
      ...
      // A, B provide 10k DCHF 
      await DCHFToken.transfer(A, dec(10000, 18), { from: whale })
      await DCHFToken.transfer(B, dec(10000, 18), { from: whale })
      ...
      const A_deposit = await stabilityPool.getCompoundedDCHFDeposit(A)
      const B_deposit = await stabilityPool.getCompoundedDCHFDeposit(B)

      const A_depositERC20 = await stabilityPoolERC20.getCompoundedDCHFDeposit(A)
      const B_depositERC20 = await stabilityPoolERC20.getCompoundedDCHFDeposit(B)
      ...
      const DCHFinSP_1 = await stabilityPool.getTotalDCHFDeposits()
      assert.equal(DCHFinSP_1, '0')

      const DCHFinSP_1ERC20 = await stabilityPoolERC20.getTotalDCHFDeposits()
      assert.equal(DCHFinSP_1ERC20, '0')

      // Check SP DCHF balance is zero
      const SPDCHFBalance_1 = await DCHFToken.balanceOf(stabilityPool.address)
      assert.equal(SPDCHFBalance_1, '0')
      ...
      // C, D provide 10k DCHF 
      await DCHFToken.transfer(C, dec(10000, 18), { from: whale })
      await DCHFToken.transfer(D, dec(10000, 18), { from: whale })
      ...
      // Check compounded deposits
      const C_deposit = await stabilityPool.getCompoundedDCHFDeposit(C)
      const D_deposit = await stabilityPool.getCompoundedDCHFDeposit(D)
      assert.equal(C_deposit, '0')
      assert.equal(D_deposit, '0')


      const C_depositERC20 = await stabilityPoolERC20.getCompoundedDCHFDeposit(C)
      const D_depositERC20 = await stabilityPoolERC20.getCompoundedDCHFDeposit(D)
      assert.equal(C_depositERC20, '0')
      assert.equal(D_depositERC20, '0')

      // Check SP tracker is zero
      const DCHFinSP_2 = await stabilityPool.getTotalDCHFDeposits()
      assert.equal(DCHFinSP_2, '0')

      const DCHFinSP_2ERC20 = await stabilityPoolERC20.getTotalDCHFDeposits()
      assert.equal(DCHFinSP_2ERC20, '0')

      // Check SP DCHF balance is zero
      const SPDCHFBalance_2 = await DCHFToken.balanceOf(stabilityPool.address)
      assert.equal(SPDCHFBalance_2, '0')
      ...
      // E, F provide 10k DCHF 
      await DCHFToken.transfer(E, dec(10000, 18), { from: whale })
      await DCHFToken.transfer(F, dec(10000, 18), { from: whale })
      ...
      // Check compounded deposits
      const E_deposit = await stabilityPool.getCompoundedDCHFDeposit(E)
      const F_deposit = await stabilityPool.getCompoundedDCHFDeposit(F)
      assert.equal(E_deposit, '0')
      assert.equal(F_deposit, '0')

      const E_depositERC20 = await stabilityPoolERC20.getCompoundedDCHFDeposit(E)
      const F_depositERC20 = await stabilityPoolERC20.getCompoundedDCHFDeposit(F)
      assert.equal(E_depositERC20, '0')
      assert.equal(F_depositERC20, '0')

      // Check SP tracker is zero
      const DCHFinSP_3 = await stabilityPool.getTotalDCHFDeposits()
      assert.equal(DCHFinSP_3, '0')

      const DCHFinSP_3ERC20 = await stabilityPoolERC20.getTotalDCHFDeposits()
      assert.equal(DCHFinSP_3ERC20, '0')

      // Check SP DCHF balance is zero
      const SPDCHFBalance_3 = await DCHFToken.balanceOf(stabilityPool.address)
      assert.equal(SPDCHFBalance_3, '0')

      const SPDCHFBalance_3ERC20 = await DCHFToken.balanceOf(stabilityPoolERC20.address)
      assert.equal(SPDCHFBalance_3ERC20, '0')
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      ...
      // Defaulters 1-5 each withdraw up to debt of 9999.9999999 DCHF
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_4, defaulter_4, { from: defaulter_4, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17)), defaulter_5, defaulter_5, { from: defaulter_5, value: dec(100, 'ether') })


      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17), erc20.address), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17), erc20.address), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17), erc20.address), defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17), erc20.address), defaulter_4, defaulter_4, { from: defaulter_4 })
      await borrowerOperations.openTrove(erc20.address, dec(100, 'ether'), th._100pct, await getOpenTroveDCHFAmount(dec(99999, 17), erc20.address), defaulter_5, defaulter_5, { from: defaulter_5 })
      ...
      // D deposits 9999.9 DCHF
      await DCHFToken.transfer(dennis, dec(99999, 17), { from: whale })
      await stabilityPool.provideToSP(dec(99999, 17), { from: dennis })
      ...
      // E deposits 9999.9 DCHF
      await DCHFToken.transfer(erin, dec(99999, 17), { from: whale })
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(1, 36)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 27) })
      ...
      // Check DCHF balances
      const aliceDCHFBalance = await DCHFToken.balanceOf(alice)
      const aliceExpectedDCHFBalance = web3.utils.toBN(dec(5, 35))
      const aliceDCHFBalDiff = aliceDCHFBalance.sub(aliceExpectedDCHFBalance.mul(toBN(2))).abs()

      assert.isTrue(aliceDCHFBalDiff.lte(toBN(dec(1, 18)))) // error tolerance of 1e18

      const bobDCHFBalance = await DCHFToken.balanceOf(bob)
      const bobExpectedDCHFBalance = toBN(dec(5, 35))
      const bobDCHFBalDiff = bobDCHFBalance.sub(bobExpectedDCHFBalance.mul(toBN(2))).abs()

      assert.isTrue(bobDCHFBalDiff.lte(toBN(dec(1, 18))))
    ...
    it("withdrawFromSP(): Small liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_1, defaulter_1, { from: defaulter_1, value: '5000000000000' })
      await borrowerOperations.openTrove(erc20.address, '5000000000000', th._100pct, await getOpenTroveDCHFAmount(dec(5000, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      const aliceDCHFBalance = await DCHFToken.balanceOf(alice)
      const aliceExpectedDCHFBalance = toBN('99999999999999997500000000000000000000').mul(toBN(2))
      const aliceDCHFBalDiff = aliceDCHFBalance.sub(aliceExpectedDCHFBalance).abs()

      assert.isTrue(aliceDCHFBalDiff.lte(toBN(dec(1, 18))))

      const bobDCHFBalance = await DCHFToken.balanceOf(bob)
      const bobExpectedDCHFBalance = toBN('99999999999999997500000000000000000000').mul(toBN(2))
      const bobDCHFBalDiff = bobDCHFBalance.sub(bobExpectedDCHFBalance).abs()

      assert.isTrue(bobDCHFBalDiff.lte(toBN('100000000000000000000')))
