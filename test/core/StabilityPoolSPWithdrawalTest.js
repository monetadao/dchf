  ...
  describe('Stability Pool Withdrawal', async () => {
    ...
    it('withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(100000, 18)),
        whale,
        whale,
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('6666666666666666666666').mul(toBN(2))
        ),
        20000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('6666666666666666666666').mul(toBN(2))
        ),
        20000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('6666666666666666666666').mul(toBN(2))
        ),
        20000
      )
    ...
    it('withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('3333333333333333333333').mul(toBN(2))
        ),
        20000
      )
      assert.isAtMost(
    ...
    it('withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing DCHF', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('6000000000000000000000').mul(toBN(2))
        ),
        20000
      )
      assert.isAtMost(
    ...
    it('withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing DCHF', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('4000000000000000000000').mul(toBN(2))
        ),
        10000
      )
      assert.isAtMost(
    ...
    it('withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('13333333333333333333333').mul(toBN(2))
        ),
        100000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('20000000000000000000000').mul(toBN(2))
        ),
        100000
      )
    ...
    it('withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('5000000000000000000000').mul(toBN(2))
        ),
        100000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('10000000000000000000000').mul(toBN(2))
        ),
        100000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('15000000000000000000000').mul(toBN(2))
        ),
        100000
      )
    ...
    it('withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(1000000, 18)),
        whale,
        whale,
      ...
      */
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('901719380174061000000').mul(toBN(2))
        ),
        100000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('205592018679686000000000').mul(toBN(2))
        ),
        10000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('5906261940140100000000').mul(toBN(2))
        ),
        10000000000
      )
    ...
    it('withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      */
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(25000, 18)),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(40000, 18)),
        defaulter_4,
        defaulter_4,
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('17832817337461300000000').mul(toBN(2))
        ),
        100000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('5944272445820430000000').mul(toBN(2))
        ),
        100000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('4458204334365320000000').mul(toBN(2))
        ),
        100000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(dennis)).toString(),
          toBN('11764705882352900000000').mul(toBN(2))
        ),
        100000000000
      )
    ...
    it('withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      */
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('1672240802675590000000').mul(toBN(2))
        ),
        10000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('2090301003344480000000').mul(toBN(2))
        ),
        100000000000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('1045150501672240000000').mul(toBN(2))
        ),
        100000000000
      )
    ...
    it('withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 DCHF. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(alice)).toString(),
          toBN('666666666666666666666').mul(toBN(2))
        ),
        100000
      )
      assert.isAtMost(
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('2000000000000000000000').mul(toBN(2))
        ),
        100000
      )
    ...
    it('withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(carol)).toString(),
          toBN('8333333333333333333333').mul(toBN(2))
        ),
        100000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(dennis)).toString(),
          toBN('16666666666666666666666').mul(toBN(2))
        ),
        100000
      )
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(erin)).toString(),
          toBN('25000000000000000000000').mul(toBN(2))
        ),
        100000
      )
    ...
    it('withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('9999999910000000000000'),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(bob)).toString(),
          toBN('100000000000000000000').mul(toBN(2))
        ),
        100000
      )
    ...
    it('withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('59400000000000000000000'),
        defaulter_2,
        defaulter_2,
      ...
      */
      assert.isAtMost(
        th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN(dec(100, 18)).mul(toBN(2))),
        100000
      )
      assert.isAtMost(
        th.getDifference((await DCHFToken.balanceOf(carol)).toString(), toBN(dec(200, 18)).mul(toBN(2))),
        100000
      )
      assert.isAtMost(
        th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN(dec(300, 18)).mul(toBN(2))),
        100000
      )
    ...
    it('withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(99999, 17)),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
      ...
      assert.isAtMost(
        th.getDifference((await DCHFToken.balanceOf(bob)).toString(), toBN(dec(1, 17)).mul(toBN(2))),
        100000
      )
    ...
    it('withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('59999400000000000000000'),
        defaulter_2,
        defaulter_2,
    ...
    it("withdrawFromSP(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('9999999999900000000000'),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
    ...
    */
    it('withdrawFromSP(): Several deposits of 10000 DCHF span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      assert.isAtMost(
        th.getDifference((await DCHFToken.balanceOf(dennis)).toString(), toBN(dec(99999, 12)).mul(toBN(2))),
        100000
      )
    ...
    it('withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24100, 18)),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(200, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24300, 18)),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2, value: dec(200, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24500, 18)),
        defaulter_3,
        defaulter_3,
        { from: defaulter_3, value: dec(200, 'ether') }
      )
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      ...
      const alice_ETHGainAt2ndScaleChangeERC20 = (
    ...
    it('withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(1, 36)),
        defaulter_1,
        defaulter_1,
