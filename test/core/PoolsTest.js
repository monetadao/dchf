...
contract('ActivePool', async (accounts) => {
  ...
  it('increaseDCHF(): increases the recorded DCHF balance by the correct amount', async () => {
    ...
    const increaseDCHFDebtData = th.getTransactionData('increaseDCHFDebt(address,uint256)', [
      ZERO_ADDRESS,
      '0x64',
    ])
  ...
  it('decreaseDCHF(): decreases the recorded DCHF balance by the correct amount', async () => {
    ...
    const decreaseDCHFDebtData = th.getTransactionData('decreaseDCHFDebt(address,uint256)', [
      ZERO_ADDRESS,
      '0x64',
    ])
