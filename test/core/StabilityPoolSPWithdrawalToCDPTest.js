  ...
  describe('Stability Pool Withdrawal', async () => {
    ...
    it('withdrawAssetGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(100000, 18), ZERO_ADDRESS),
        whale,
        whale,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(100000, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(100000, 18), erc20.address),
        whale,
        whale,
        { from: whale }
      )
      ...
      const txAERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: alice,
      })
      const txBERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: bob,
      })
      const txCERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: carol,
      })
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedDCHFDeposit(alice)).toString(),
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedDCHFDeposit(bob)).toString(),
          '6666666666666666666666'
        ),
        10000
      )
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedDCHFDeposit(carol)).toString(),
          '6666666666666666666666'
        ),
        10000
      )
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPoolERC20.getCompoundedDCHFDeposit(alice)).toString(),
          '6666666666666666666666'
        ),
        10000
      )
      assert.isAtMost(
        th.getDifference(
          (await stabilityPoolERC20.getCompoundedDCHFDeposit(bob)).toString(),
          '6666666666666666666666'
        ),
        10000
      )
      assert.isAtMost(
        th.getDifference(
          (await stabilityPoolERC20.getCompoundedDCHFDeposit(carol)).toString(),
          '6666666666666666666666'
        ),
        10000
      )
    ...
    it('withdrawAssetGainToTrove():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations', async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(alice)).toString(), '0'),
        10000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(bob)).toString(), '0'),
        10000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(carol)).toString(), '0'),
        10000
      )

      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(alice)).toString(), '0'),
        10000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(bob)).toString(), '0'),
        10000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(carol)).toString(), '0'),
        10000
      )
    ...
    it('withdrawAssetGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing DCHF', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(5000, 18)),
        defaulter_1,
        defaulter_1,
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(7000, 18)),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        th._100pct,
        await getOpenTroveDCHFAmount(dec(5000, 18), erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      await borrowerOperations.openTrove(
        ...
        th._100pct,
        await getOpenTroveDCHFAmount(dec(7000, 18), erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
    ...
    it('withdrawAssetGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing DCHF', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(6000, 18)),
        defaulter_2,
        defaulter_2,
    ...
    it('withdrawAssetGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(1000000, 18), ZERO_ADDRESS),
        whale,
        whale,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(1000000, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(1000000, 18), erc20.address),
        whale,
        whale,
        { from: whale }
      )
      ...
      */
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('207000000000000000000000'),
        defaulter_1,
        defaulter_1,
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(5, 21)),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('46700000000000000000000'),
        defaulter_3,
        defaulter_3,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(2160, 18),
        th._100pct,
        await getOpenTroveDCHFAmount('207000000000000000000000', erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      await borrowerOperations.openTrove(
        ...
        dec(50, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(5, 21), erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
      await borrowerOperations.openTrove(
        ...
        dec(500, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount('46700000000000000000000', erc20.address),
        defaulter_3,
        defaulter_3,
        { from: defaulter_3 }
      )
    ...
    it('withdrawAssetGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 DCHF.  A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      const txDERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: dennis,
      })
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedDCHFDeposit(dennis)).toString(),
          '5000000000000000000000'
        ),
        100000
      )
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPoolERC20.getCompoundedDCHFDeposit(dennis)).toString(),
          '5000000000000000000000'
        ),
        100000
      )
    ...
    it('withdrawAssetGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 DCHF.  A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(dennis)).toString(), '0'),
        100000
      )
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(dennis)).toString(), '0'),
        100000
      )
    ...
    it('withdrawAssetGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      */
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(25000, 18), ZERO_ADDRESS),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(5000, 18), ZERO_ADDRESS),
        defaulter_3,
        defaulter_3,
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(40000, 18), ZERO_ADDRESS),
        defaulter_4,
        defaulter_4,
      ...
      await borrowerOperations.openTrove(
        ...
        th._100pct,
        await getOpenTroveDCHFAmount(dec(25000, 18), erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
      ...
      await borrowerOperations.openTrove(
        ...
        dec(400, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(40000, 18), erc20.address),
        defaulter_4,
        defaulter_4,
        { from: defaulter_4 }
      )
    ...
    it('withdrawAssetGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      */
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(dennis)).toString(),
          toBN('27692307692307700000000').mul(toBN(2))
        ),
        200000000000
      )
    ...
    it('withdrawAssetGainToTrove(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 DCHF. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct DCHF deposit and ETH Gain', async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await DCHFToken.balanceOf(dennis)).toString(),
          toBN('1666666666666666666666').mul(toBN(2))
        ),
        200000
      )
    ...
    it('withdrawAssetGainToTrove(): Depositors withdraw correct compounded deposit after liquidation empties the pool', async () => {
      ...
      const txEERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: erin,
      })
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedDCHFDeposit(erin)).toString(),
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPoolERC20.getCompoundedDCHFDeposit(erin)).toString(),
          '25000000000000000000000'
        ),
        100000
      )
    ...
    it('withdrawAssetGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool', async () => {
      ...
      const txFERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: flyn,
      })
      const txGERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: graham,
      })
      const txHERC20 = await stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: harriet,
      })
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(erin)).toString(), '0'),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(flyn)).toString(), '0'),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(graham)).toString(), '0'),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(harriet)).toString(), '0'),
        100000
      )
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(erin)).toString(), '0'),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(flyn)).toString(), '0'),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(graham)).toString(), '0'),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(harriet)).toString(), '0'),
        100000
      )
    ...
    it('withdrawAssetGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('9999999910000000000000', ZERO_ADDRESS),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        dec(100, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount('9999999910000000000000', erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(9900, 18)),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(60, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(9900, 18), erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
    ...
    it('withdrawAssetGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('59400000000000000000000', ZERO_ADDRESS),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(330, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount('59400000000000000000000', erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
      ...
      */
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(bob)).toString(), dec(100, 18)),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(carol)).toString(), dec(200, 18)),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(dennis)).toString(), dec(300, 18)),
        100000
      )

      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(bob)).toString(), dec(100, 18)),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(carol)).toString(), dec(200, 18)),
        100000
      )
      assert.isAtMost(
        th.getDifference(
    ...
    it('withdrawAssetGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(99999, 17), ZERO_ADDRESS),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
      ...
      await borrowerOperations.openTrove(
        ...
        dec(100, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(99999, 17), erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(bob)).toString(), dec(1, 17)),
        100000
      )
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, dec(995, 17)), 100000000000)

      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(bob)).toString(), dec(1, 17)),
        100000
      )
    ...
    it('withdrawAssetGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('9999900000000000000000', ZERO_ADDRESS),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('59999400000000000000000', ZERO_ADDRESS),
        defaulter_2,
        defaulter_2,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(100, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount('9999900000000000000000', erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      await borrowerOperations.openTrove(
        ...
        dec(600, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount('59999400000000000000000', erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(carol)).toString(), dec(2, 17)),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(dennis)).toString(), dec(3, 17)),
        100000
      )
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(carol)).toString(), dec(2, 17)),
        100000
      )
      assert.isAtMost(
        th.getDifference((await stabilityPoolERC20.getCompoundedDCHFDeposit(dennis)).toString(), dec(3, 17)),
        100000
      )
    ...
    it("withdrawAssetGainToTrove(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount('9999999999900000000000', ZERO_ADDRESS),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(100, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        dec(100, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount('9999999999900000000000', erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
    ...
    */
    it('withdrawAssetGainToTrove(): Several deposits of 10000 DCHF span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation', async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedDCHFDeposit(dennis)).toString(), dec(99999, 12)),
        100000
      )
      assert.isAtMost(
        th.getDifference(
    ...
    it('withdrawAssetGainToTrove(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation', async () => {
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24100, 18), ZERO_ADDRESS),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1, value: dec(200, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24300, 18), ZERO_ADDRESS),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2, value: dec(200, 'ether') }
      )
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24500, 18), ZERO_ADDRESS),
        defaulter_3,
        defaulter_3,
        { from: defaulter_3, value: dec(200, 'ether') }
      )
      ...
      await borrowerOperations.openTrove(
        ...
        dec(200, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24100, 18), erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      await borrowerOperations.openTrove(
        ...
        dec(200, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24300, 18), erc20.address),
        defaulter_2,
        defaulter_2,
        { from: defaulter_2 }
      )
      await borrowerOperations.openTrove(
        ...
        dec(200, 'ether'),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(24500, 18), erc20.address),
        defaulter_3,
        defaulter_3,
        { from: defaulter_3 }
      )
    ...
    it('withdrawAssetGainToTrove(): Large liquidated coll/debt, deposits and ETH price', async () => {
      ...
      const depositors = [alice, bob]
      for (account of depositors) {
        await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, dec(1, 36), account, account, {
          from: account,
          value: dec(2, 27),
        })
        await borrowerOperations.openTrove(
      ...
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveDCHFAmount(dec(1, 36), ZERO_ADDRESS),
        defaulter_1,
        defaulter_1,
      ...
      await borrowerOperations.openTrove(
        ...
        dec(1, 27),
        th._100pct,
        await getOpenTroveDCHFAmount(dec(1, 36), erc20.address),
        defaulter_1,
        defaulter_1,
        { from: defaulter_1 }
      )
      ...
      const alice_ETHWithdrawnERC20 = th.getEventArgByName(
        txAERC20,
        EVENT_ASSET_GAIN_NAME,
        EVENT_ASSET_GAIN_PARAM
      )
      const bob_ETHWithdrawnERC20 = th.getEventArgByName(
        txBERC20,
        EVENT_ASSET_GAIN_NAME,
        EVENT_ASSET_GAIN_PARAM
      )
    ...
    it('withdrawAssetGainToTrove(): Small liquidated coll/debt, large deposits and ETH price', async () => {
      ...
      const depositors = [alice, bob]
      for (account of depositors) {
        await borrowerOperations.openTrove(ZERO_ADDRESS, 0, th._100pct, dec(1, 38), account, account, {
          from: account,
          value: dec(2, 29),
        })
        await borrowerOperations.openTrove(
      ...
      const txAPromiseERC20 = stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: alice,
      })
      const txBPromiseERC20 = stabilityPoolERC20.withdrawAssetGainToTrove(ZERO_ADDRESS, ZERO_ADDRESS, {
        from: bob,
      })
