...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 DCHF
    ...
    //1 accts open Trove with 1 ether and withdraw 100 DCHF
    ...
    // Account 500 opens with 1 ether and withdraws 100 DCHF
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 DCHF
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 DCHF
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion DCHF
    ...
    //Check DCHF in SP has decreased but is still > 0
    const USDVinSP_After = await stabilityPool.getTotalDCHFDeposits()
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 DCHF
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 DCHF
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'ether'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 DCHF
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraws DCHF

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ether and withdraws DCHF
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 DCHF
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS, { from: accounts[500], value: dec(100, 'ether') })
